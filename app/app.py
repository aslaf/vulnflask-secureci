...
def init_db():
    ...
    try:
        ...
        db.execute(
            "INSERT INTO products (name,description,price) VALUES ('Widget','<b>Great widget</b>',9.99)"
        )
        db.execute(
            "INSERT INTO products (name,description,price) VALUES ('Gadget','<script>alert(1)</script>',19.99)"
        )
        db.commit()
    except Exception:
        pass
